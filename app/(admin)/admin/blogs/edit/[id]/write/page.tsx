...
import EditBlogBootstrap from "../../EditBlogBootstrap";
import ClientBlogWrite from "../../../new/components/ClientBlogWrite";
import SaveToDatabaseButtons from "../../../new/components/SaveToDatabaseButtons";
import { cn } from "@/lib/utils";

export default async function EditBlogWritePage({
  params,
}: {
  ...
  return (
    <EditBlogBootstrap postId={id}>
      <div className="px-4 py-6 sm:px-6 lg:px-8">
        <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-xs font-medium text-zinc-500">Blog / Edit</p>
            <h2 className="mt-1 text-xl font-semibold tracking-tight">Write</h2>
          </div>
          <div className="flex flex-wrap gap-2">
            <Link
              href={`/admin/blogs/edit/${id}/details`}
