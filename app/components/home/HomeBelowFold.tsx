...
function TradingFeatureCard({
  ...
  return (
    <div className={cn(tradingCardShell, cardHoverShell, "text-left")}>
      ...
      {/* Card background: static bars — smaller, bottom-right (not full-bleed) */}
      <div className="pointer-events-none absolute inset-0 z-[1] opacity-100">
        <div
          aria-hidden
          className="absolute bottom-0 right-0 h-[min(52%,13rem)] w-[min(70%,19.5rem)] sm:h-[min(54%,14rem)] sm:w-[min(72%,21rem)]"
        >
          <StaticChartBars className="h-full w-full max-h-full object-contain object-bottom-right" />
        </div>
        {/* Fade so left text stays readable; lighter on the right so bars read stronger */}
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-[radial-gradient(900px_520px_at_75%_40%,rgba(0,0,0,0.06),rgba(0,0,0,0.48)_58%,rgba(0,0,0,0.62)_100%)]"
        />
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,0,0,0.72)_0%,rgba(0,0,0,0.38)_44%,rgba(0,0,0,0.14)_100%)]"
        />
      </div>
          ...
          <div className="relative z-10 mx-auto w-[97%] max-w-none px-4 py-[200px] sm:w-[85%] sm:px-6 lg:px-8">
            ...
            <div className="mx-auto mt-12 max-w-5xl">
              <div className="grid gap-10 lg:grid-cols-2 lg:gap-12">
                ...
                <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-[0_18px_55px_rgba(0,0,0,0.45)] sm:p-7">
                  <div
                    aria-hidden="true"
