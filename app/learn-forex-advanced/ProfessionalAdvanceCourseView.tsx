...
import { getProfessionalAdvanceCourseForPublic } from "@/lib/public-course";
...
export default async function ProfessionalAdvanceCourseView() {
  const course = await getProfessionalAdvanceCourseForPublic();
  ...
  const displayTitle =
    course.title.trim() || defaultProfessionalAdvanceTitle;
  const displayEyebrow =
    course.eyebrow.trim() || defaultProfessionalAdvanceEyebrow;
      ...
      <section className="mt-14">
        ...
        {lessons.length > 0 ? (
          ...
          <p className="mt-4 text-sm text-white/55">
            No lessons yet. Add video links in Admin → Professional Advance course.
          </p>
        )}
      </section>
